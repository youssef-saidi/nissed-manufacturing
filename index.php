...
<script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
 ...
 <section id="count-er" class=" flex justify-center">
        ...
        <div class="count"></div>
      <div><img src="image/Logo 120x120.png" class="relative top-1/3 md:top-1/4 md:w-44 md:h-44 "  alt="Nissed manufacturing"></div>  
    </section>
    ...
    <main   >
        <div class="relative flex w-full">
            <div
                ...
                <a data-aos="zoom-in"  data-aos-duration="3000" title="Choose Music" href="#music"
    ...
    <div class="container">
        ...
        data-aos-easing="ease-in-sine">
			<div class="content">
				...
				<a href="service1.php"><?php echo $lang['read-more'] ?></a>
			</div>
		</div>
		<div class="card" data-aos="fade-down"
        data-aos-offset="300"

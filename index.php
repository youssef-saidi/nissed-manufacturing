			...
			<nav class="flex items-center bg-transparent p-3 flex-wrap " id="navbar">
				...
				<div id="navig" class="top-nav w-full lg:inline-flex lg:flex-grow lg:w-auto">
					<div class="lg:inline-flex lg:flex-row lg:m-auto flex flex-col font-semibold hidden  " id="toggle">
						<a href="index.php" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full  text-black  menu w-24 "> <span><?php echo $lang['navbar-item-1'] ?></span>
						</a>
						...
						<a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24"> <span><?php echo $lang['navbar-item-3'] ?></span>
						</a>

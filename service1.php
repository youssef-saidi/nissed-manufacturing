...
<body class="bg-gray-200">
		...
		<nav class="flex items-center bg-transparent p-3 flex-wrap " id="navbar" style="background-color: #212121;">
			...
			<div id="navig" class="top-nav w-full lg:inline-flex lg:flex-grow lg:w-auto">
				<div class="lg:inline-flex lg:flex-row lg:m-auto flex flex-col font-semibold hidden " id="toggle">
					<a href="index.php" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full  text-white  menu w-24 "> <span><?php echo $lang['navbar-item-1'] ?></span>
					</a>
					<a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24 "> <span><?php echo $lang['navbar-item-2'] ?></span>
					</a>
					...
					<div class=" relative mt-1 lg:left-1/2 left-4 text-white"> <a href="service1.php?lang=fr" class=" hover:text-blue-500"><span>Fr</span></a> / <a href="service1.php?lang=en" class="hover:text-blue-500"><span >Eng</span></a>
					</div>
				</div>
			</div>
	...
	<div class="  grid   md:grid-cols-3 sm:grid-cols-2    grid-cols-1 justify-items-center mx-4 mt-24 lg:my-24 sm:my-56  ">
		<div class="   w-max items-center font-semibold md:text-l  px-3 py-2 text-sm shadow    text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#1">
				<?php echo $lang[ 'title-CAO'] ?>
			</a>
		</div>
		<div class=" w-max items-center font-semibold md:text-l  px-3 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#2">
				<?php echo $lang[ 'title-I'] ?>
			</a>
		</div>
		<div class=" w-max items-center font-semibold md:text-l px-3 py-2 text-sm shadow  text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#3">
				<?php echo $lang[ 'title-C-Q'] ?>
			</a>
		</div>
		<div class=" w-max items-center font-semibold md:text-l px-3 py-2 text-sm shadow  text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#4">
				<?php echo $lang[ 'title-w'] ?>
			</a>
		</div>
		<div class="  w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#5">
				<?php echo $lang[ 'title-H'] ?>
			</a>
		</div>
		<div class=" w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#6">
				<?php echo $lang[ 'title-P'] ?>
			</a>
		</div>
		<div class=" w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#7">
				<?php echo $lang[ 'title-E'] ?>
			</a>
		</div>
		<div class=" w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in">
			<a href="#8">
				<?php echo $lang[ 'title-fao'] ?>
			</a>
		</div>
	</div>
	<section id="produit">
		<div id="1"></div>
		<!-- bloc1 -->
		<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  ">
			...
			<div class="md:px-10  sm:py-1/2 w-full h-1/2  ">
				...
				<p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in" data-aos-duration="1500">
					<?php echo $lang[ 'Para-C-A-D'] ?>
				</p>
				<div>
					<ul class="about-link justify-items-center sm:w-full  w-3/4 ">
						<li><a href="https://www.facebook.com/Nissed-Manufacturing-108347454661551"><i class="fa fa-facebook sm:m-0  sm:w-12 sm:h-12 w-10 h-10"></i></a>
						</li>
						<li><a href="https://www.linkedin.com/company/nissed-manufacturing/?fbclid=IwAR0DD_gSt0AOF9xRgKS6rcXIHgZfkZJNurmtZ6D4za8S__3iqvTBSK9pmqA"><i class="fa fa-linkedin  sm:w-12 sm:h-12 w-10 h-10"></i></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  ">
			...
			<div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
				...
				<p class="md:text-left text-left text-sm lg:w-3/4  md:w-full " data-aos="zoom-in-left" data-aos-duration="1500">
					<?php echo $lang[ 'Para-I'] ?>
				</p>
				<div>
					<ul class="about-link justify-items-center sm:w-full  w-3/4 ">
						<li><a href="https://www.facebook.com/Nissed-Manufacturing-108347454661551"><i class="fa fa-facebook sm:m-0  sm:w-12 sm:h-12 w-10 h-10"></i></a>
		...
		<!-- bloc5 -->
		<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  ">
			<img src="image/hydraulique.jpg" class="rounded-3xl  w-full md:w-80 h-56  lg:ml-28 md:ml-5   " data-aos="fade-down" data-aos-duration="2000" alt="Hydraulic">
			<div class="md:px-12  sm:py-1/2 w-full h-1/2 ">
				<h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-H'] ?></h1>
				<p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in" data-aos-duration="1500">
					<?php echo $lang[ 'Para-H'] ?>
				</p>
				<div>
					<ul class="about-link justify-items-center sm:w-full  w-3/4 ">
						<li><a href="https://www.facebook.com/Nissed-Manufacturing-108347454661551"><i class="fa fa-facebook sm:m-0  sm:w-12 sm:h-12 w-10 h-10"></i></a>
		...
		<!-- bloc6 -->
		<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  ">
			<img src="image/pneumatique.jpg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5" data-aos="fade-down" data-aos-duration="2000" alt="Pneumatic">
			<div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
				<h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-P'] ?></h1>
				<p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in" data-aos-duration="1500">
					<?php echo $lang[ 'Para-P'] ?>
				</p>
				<div>
					<ul class="about-link justify-items-center sm:w-full  w-3/4 ">
						<li><a href="https://www.facebook.com/Nissed-Manufacturing-108347454661551"><i class="fa fa-facebook sm:m-0  sm:w-12 sm:h-12 w-10 h-10"></i></a>
		...
		<!-- bloc8 -->
		<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  ">
			<img src="image/FAO.jpg" class="rounded-3xl   md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-down" data-aos-duration="2000" alt="CAO-DAO">
			<div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
				<h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-fao'] ?></h1>
				<p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in" data-aos-duration="1500">
					<?php echo $lang[ 'Para-fao'] ?>
				</p>
				<div>
					<ul class="about-link justify-items-center sm:w-full  w-3/4 ">
						<li><a href="https://www.facebook.com/Nissed-Manufacturing-108347454661551"><i class="fa fa-facebook sm:m-0  sm:w-12 sm:h-12 w-10 h-10"></i></a>

		...
		<a href="index.php"><img src="image/Logo nissed VF_Plan de travail 1.png" class="w-32 h-16 items-center" alt="Nissed Manufacturing"></a>	
			...
			<div id="navig" class="top-nav w-full lg:inline-flex lg:flex-grow lg:w-auto">
				...
				<a href="index.php" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full  text-black  menu w-24 "> <span class="items-nav-nav"><?php echo $lang['navbar-item-1'] ?></span>
						...
						<a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24 "> <span class="items-nav-nav"><?php echo $lang['navbar-item-2'] ?></span>
						</a>
						...
						<div class=" relative mt-1 lg:left-1/2 left-4 text-white"> <a href="service1.php?lang=fr" class=" hover:text-blue-500"><span class="items-nav-nav">Fr</span></a> / <a href="service1.php?lang=en" class="hover:text-blue-500"><span class="items-nav-nav"  >Eng</span></a>
						</div>
				</div>
			</div>

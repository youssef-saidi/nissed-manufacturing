...
<script>
  ...
  <header  class="fixed left-0 top-0 w-full z-50  ">
   ...
   <div class="  grid   md:grid-cols-3 sm:grid-cols-2    grid-cols-1 justify-items-center mx-4 mt-24 lg:my-24 sm:my-56  ">
    ...
    <div  class=" w-max items-center font-semibold md:text-l px-3 py-2 text-sm shadow  text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  " data-aos="zoom-in"><a href="#4"><?php echo $lang['title-w'] ?></a></div>
    <div  class="  w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  "data-aos="zoom-in"><a href="#5"><?php echo $lang['title-H'] ?></a></div>
    <div  class=" w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  "data-aos="zoom-in"><a href="#6"><?php echo $lang['title-P'] ?></a></div>
    <div  class=" w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  "data-aos="zoom-in"><a href="#7"><?php echo $lang['title-E'] ?></a></div>
    <div  class=" w-max items-center font-semibold md:text-l px-10 py-2 text-sm shadow   text-white  bg-gray-900 hover:bg-gray-800 rounded-md md:my-3 my-6  "data-aos="zoom-in"><a href="#8"><?php echo $lang['title-fao'] ?></a></div>
